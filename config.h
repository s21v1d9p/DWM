...
static Key keys[] = {
	...
	{ MODKEY,			XK_F11,	   spawn,	   SHCMD("pamixer --allow-boost -d 5; kill -44 $(pidof dwmblocks)") },   //audio
	{ MODKEY,                       XK_F10,    spawn,          SHCMD("pamixer -t; kill -44 $(pidof dwmblocks)") }, //audio
	{ MODKEY,                       XK_F12,    spawn,          SHCMD("pamixer --allow-boost -i 5; kill -44 $(pidof dwmblocks)") },   //audio
	{ 0,               XF86XK_AudioLowerVolume,spawn,          SHCMD("pamixer --allow-boost -d 5; kill -44 $(pidof dwmblocks)") }, //audio
	{ 0,               XF86XK_AudioMute,       spawn,          SHCMD("pamixer -t; kill -44 $(pidof dwmblocks)") }, //audio
	{ 0,               XF86XK_AudioRaiseVolume,spawn,          SHCMD("pamixer --allow-boost -i 5; kill -44 $(pidof dwmblocks)") }, //audio
